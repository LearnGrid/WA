...
- \`src/components/RecipeCard.tsx\``
        ...
        {
            title: "Let users browse and save recipes on mobile",
            category: "new_artifact",
            artifactKinds: ["mobile"],
            description: `# Let users browse and save recipes on mobile
